...
| Key                           | Is                                             | Signs                                                                                                   | Calls                                                                                              |
| ----------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| The funding account, `player` | The account that sent the deposit              | `Close`; a test channel's `owner` proof                                                                 | `openChannel`, `startClose`, `claimTo`; it is the claim's recipient unless `claimTo` names another |
