...
| `risk`                                                                                                 | The closed-form commission against exhaustive enumeration and an independent integer-root oracle, a bet's payout at the edge of its chance, and that a signed operation binds every field and the deployment |
