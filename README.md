...
- **Bets that settle later trust their referee.** A game's referee draws its players' bets against the bankroll on one outcome, fixed before any of them is placed: the casino names the round and the referee commits its seed to it first, so nobody can change the outcome and neither knows it alone. Together they could know it, and turn winning bets away, which their receipts would show. The referee chooses when, never what a drawn bet pays. A bet with terms pays what its referee signs, and what it wins beyond its stake comes from the game developer's bank. A bet nobody settles by its deadline is refunded. Each bet's receipt says whose word it rests on.
