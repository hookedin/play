...
| [games/](games/)                               | The house's static games: [samson](games/samson/), [plinko](games/plinko/), [dice](games/dice/), [blackjack](games/blackjack/), [mines](games/mines/). Roulette, with its server, is [hookedin/game-roulette](https://github.com/hookedin/game-roulette) |
...
| [vectors/protocol.json](vectors/protocol.json) | Committed vectors for the signed messages, pricing and outcomes                                                                                                                                                                                          |
...
Roulette, the house's game with a server, tests and publishes itself from its own repository, [hookedin/game-roulette](https://github.com/hookedin/game-roulette).
