...
- The game SDK and the house's games, [sdk/](sdk/) and [games/](games/): step pricing that disagrees with the risk rule, a game losing its saved round, a referee giving away the seed of a draw before it draws.
...
The trust assumptions stated in [README.md](README.md#trust-model) and [architecture.md](architecture.md) are accepted design choices: one operator controls signing and the bankroll, winnings above the deposit are unsecured claims on the shared pool, the player must challenge a stale close within 24 hours, the casino can withhold completion, a game's referee and the casino together could know a draw's outcome in advance and turn bets away, a bet its referee splits pays what the referee signs, and bankroll fund shares are the casino's promise. Reports that restate these are welcome as design feedback in a public issue.
